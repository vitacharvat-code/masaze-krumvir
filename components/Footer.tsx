    ...
    <footer className="bg-[#001A52] text-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4 text-white/30 text-xs">
            <span>© {year} Cristian Balaci. Všechna práva vyhrazena.</span>
            <span className="hidden sm:inline text-white/15">|</span>
            <span>IČO: 11676809 · Se sídlem Krumvíř 291, 691 73</span>
            <span className="hidden sm:inline text-white/15">|</span>
            <span>Masér bez pevné provozovny</span>
          </div>
